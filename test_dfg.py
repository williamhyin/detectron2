...
my_dataset_train="/home/iav/code/trafficsign/dfg/images/train"
json_annotation_train="/home/iav/code/trafficsign/dfg/labels/train_ori.json"
my_dataset_val="/home/iav/code/trafficsign/dfg/images/test"
json_annotation_val="/home/iav/code/trafficsign/dfg/labels/test_ori.json"
...
metadata=MetadataCatalog.get(my_dataset_val_name).set(thing_classes=class_map)
data_dicts=DatasetCatalog.get(my_dataset_val_name)
...
visualizer1=Visualizer(img,metadata,instance_mode=ColorMode.IMAGE)
visualizer2=Visualizer(img,metadata,instance_mode=ColorMode.SEGMENTATION)
dict_ori=deepcopy(dict)
dict_ori['annotations']=None

image_visual1=visualizer1.draw_dataset_dict(dict)
cv2.imshow('SEGMENTATION',image_visual1.get_image())
cv2.waitKey(0)

image_visual2=visualizer2.draw_dataset_dict(dict)
cv2.imshow('IMAGE_BW',image_visual2.get_image())
cv2.waitKey(0)
